...
/**
 * Constructs the embed for the timeout DM notification
 ...
 */
export function timeout(target, executor, guild, display, caseData) {
	return applyGlobals(
		new EmbedBuilder()
			.setColor(client.config.colors.orange)
			.setDescription(`You have been timed out in ${guild.name}. If you believe that this was a mistake, please contact ${display.tag} (don't spam though, unless you want to be blocked)`)
