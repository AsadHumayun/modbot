...
/**
 * Constructs the embed for the softban DM notification
 ...
 */
export function softban(target, executor, guild, display, caseData) {
	return applyGlobals(
		new EmbedBuilder()
			.setColor(client.config.colors.orange)
			.setDescription(`You have been soft-banned from ${guild.name}. If you believe that this was a mistake, please contact ${display.tag} (don't spam though, unless you want to be blocked)`)
