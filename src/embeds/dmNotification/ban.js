...
/**
 * Constructs the embed for the ban DM notification
 ...
 */
export function ban(target, executor, guild, display, caseData) {
	return applyGlobals(
		new EmbedBuilder()
			.setColor(client.config.colors.red)
			.setDescription(`You have received a permanent ban from ${guild.name}. If you believe that this was a mistake, please contact ${display.tag} (don't spam though, unless you want to be blocked).`)
